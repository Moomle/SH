...
public class MD5Util {
	...
	public static String md5Encode(String content, String key){
		String toEncode = (content == null ? "" : content) + key;
		try {
			return strToMD5(toEncode);
		} catch (Exception e) {
	...
	public static String md5Signature(String paramsMap){
		if (paramsMap == null || paramsMap.isEmpty()) {
			return "";
		}
		return MD5Util.md5Encode(paramsMap, Constant.MD5_KEY);
	}
