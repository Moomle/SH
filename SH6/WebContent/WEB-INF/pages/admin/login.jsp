...
<html lang="en">  
  <head>
    ...
    />
   	 <title>Bootstrap3响应式后台管理系统模版MeAdmin 用户登录页面 - JS代码网</title>
    ...
    <script type="text/javascript" src="<%=path%>/plugins/validation/jquery.validate.min.js">
    </script>
    <script type="text/javascript" src="<%=path%>/plugins/nprogress/nprogress.js">
    </script>
    <script type="text/javascript" src="<%=path%>/assets/js/login.js">
    </script>
    <script>
    ...
    <div class="box">
      ...
      <div class="inner-box">
        <div class="content">
          ...
          <form class="form-vertical forgot-password-form hide-default" action="login.html"
          method="post">
            <div class="form-group">
              <div class="input-icon">
                <i class="icon-envelope">
